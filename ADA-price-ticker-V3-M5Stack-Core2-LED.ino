...
//16 September 2021
//Cardano Ticker
//Modified from Oxinon's original version "https://github.com/oxinon/IOTA-price-ticker-V3-M5Stack-Core2"
...
// LED STUFF DOWN
  ...
  fade.addLeds(leds, NUM_LEDS, QUEUE_LENGTH);
...
// LED STUFF UP
  ...
  preferences.begin("wifi-config");
    ...
    M5.Lcd.setSwapBytes(true);
    M5.Lcd.pushImage(30, 80, adaWidth, adaHeight, ada);
    delay(4000);
    M5.Lcd.fillScreen(TFT_BLACK); 
...
void printTickerDataADA(String ticker)
{
...
// print signal bars
        ...
        M5.Lcd.pushImage(15, 35, ada2Width, ada2Height, ada2);
...
// Line
        ...
        M5.Lcd.drawString("ADA Price Ticker", 65, 4, 4);
...
// Price
        ...
        M5.Lcd.drawString(String(response.price).c_str(), 120, 50, 6);
        if(currency == "EUR"){
...
// Rank
        ...
        M5.Lcd.drawString("Rank:", 120, 100, 4);
...
// hours change
        ...
        if (response.percent_change_1h < 0 && fade.allQueuesEmpty()) {
            M5.Lcd.setTextColor(RED);
        // Red swish...
            for (int i = 0; i < 10; i++) {
